...
const buttonVariants = cva(
  "inline-flex cursor-pointer items-center justify-center gap-2 whitespace-nowrap rounded-xl text-sm font-semibold transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 focus-visible:ring-offset-background disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        default:
          "brand-gradient-strong border border-transparent text-primary-foreground shadow-brand-button hover:-translate-y-px hover:shadow-brand-button-hover",
        destructive: "bg-destructive text-destructive-foreground shadow-sm hover:bg-destructive/90",
        outline:
          "border border-border/80 bg-card text-foreground shadow-sm hover:border-border-strong hover:bg-brand-subtle",
        outlineOnDark:
          "border border-white/30 bg-transparent text-white shadow-none hover:border-white/50 hover:bg-white/10 hover:text-white",
